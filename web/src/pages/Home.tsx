        ...
        <div className="bg-white text-blue-900 p-10 lg:p-20 flex flex-col lg:flex-row gap-10 items-center ">
          <div className="flex-1 text-left">
            ...
            <p className="text-lg lg:text-xl mb-6">
              Pulsora facilite la gestion des équipes sportives, l’organisation
              des entraînements et la communication entre entraîneurs, joueurs
              et responsables, tout en permettant aux fans de suivre l’actualité
          ...
          <div className="flex-1 relative">
            <img
              className="w-5/6 md:w-4/6 rounded-lg shadow-lg ml-20"
              src={img2}
              alt="Player Home"
            />
          </div>
